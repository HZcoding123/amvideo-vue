<template>
  <div class="register">
    <div class="popup-content">
      <div class="close-btn">
        <el-icon style="color: white; font-size: 20px" @click="close_register"><close-bold /></el-icon>
      </div>
      <div class="signin">
        ...
        <div class="other-way">
          <div @click="change_login_register"><span class="link-btn">立即登录</span></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods:{
    ...
    register() {
      ...
      axios.post(this.$settings.base_url + '/user/register/',{
        telephone: this.mobile,
